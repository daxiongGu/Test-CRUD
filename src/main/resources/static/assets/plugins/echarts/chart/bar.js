    ...
    return t.prototype = {
        type: a.CHART_TYPE_BAR, _buildShape: function () {
            ...
            for (var o = this.series, r = 0, s = i.length; s > r; r++) for (var l = 0, h = i[r].length; h > l; l++) {
                var d = i[r][l], c = o[d], m = c.xAxisIndex || 0, p = this.component.xAxis.getAxis(m),
                    u = p.getCoord(0), V = c.yAxisIndex || 0, U = this.component.yAxis.getAxis(V), g = U.getCoord(0);
                a[d] = a[d] || {
                ...
                for (var f = 0, y = c.data.length; y > f; f++) {
                    ...
                    if (_ instanceof Array) {
                        var x, k, v = p.getCoord(_[0]), L = U.getCoord(_[1]), w = [b, c],
                            W = this.deepQuery(w, "barWidth") || 10, X = this.deepQuery(w, "barHeight");
            ...
            var n, a, o = this._findSpecialBarSzie(t, i), r = o.barWidthMap, s = o.barMaxWidthMap,
                l = o.barMinHeightMap, h = o.sBarWidthCounter, d = o.sBarWidthTotal, c = o.barGap, m = o.barCategoryGap,
                p = 1;
            if (t.length != h) {
            ...
            var d, c = this.series, m = c[e], p = m.data[t], u = this._sIndex2ColorMap[e], V = [p, m],
                U = this.deepMerge(V, "itemStyle.normal"), g = this.deepMerge(V, "itemStyle.emphasis"),
                f = U.barBorderWidth;
            d = {
                zlevel: m.zlevel,
                z: m.z,
            ...
            var i, n, a = this.series[e], o = this.xMarkMap[e], r = this.component.xAxis.getAxis(a.xAxisIndex),
